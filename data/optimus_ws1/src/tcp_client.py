...
test_msg2 = packMasg(1,1007,{"task_ids":["OPTIMUS0"]})
print("\n\nreq:")
print(' '.join('{:02X}'.format(x) for x in test_msg2))
# so.send(test_msg)
so.send(test_msg2)
...
if(len(data) < 16):
    ...
    print("{:02X} {:02X} {:04X} {:08X} {:04X} {:02X} {:02X} {:02X} {:02X} {:02X} {:02X}       length: {}".format(header[0], header[1], header[2], header[3], header[4], header[5][0], header[5][1], header[5][2], header[5][3], header[5][4], header[5][5], header[3]))
