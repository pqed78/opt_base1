...
class packMasg_client2:
    ...
    def tcp_socket_connection(self): #socket connection, request action, and receive response
        ...
        try:
            ...
            if self.Port ==19204 and self.msg !={}:
                temp=json.loads(data)
                temp0=[]

                for i in range(len(list(self.msg.keys()))):
                    # print(i) # To count the number of element in the list
                    temp0.append(temp[list(self.msg.keys())[i]])
                # print(temp0)    
                return temp0
                ...
                return json.loads(data) # to change JSON object to python object 
